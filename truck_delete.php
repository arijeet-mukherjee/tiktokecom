            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Delete Record</h6>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">Delete Truck Owner</h3>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" id="get-table-data" class="btn btn-danger" name="delete_truck_data">Delete</button>
