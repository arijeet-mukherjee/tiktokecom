    ...
    <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?= ($_SESSION['page'] == 'Dashboard') ? 'active' : '' ?>" href="dashboard.php" >
                            <i class="ni ni-shop text-primary"></i>
                            <span class="nav-link-text">Dashboards</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($_SESSION['page'] == 'Create table') ? 'active' : '' ?>" href="create_table.php" >
                            <i class="fa fa-plus text-orange"></i>
                            <span class="nav-link-text">Table Create</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($_SESSION['page'] == 'List of table' || $_SESSION['page'] == 'View table'  || $_SESSION['page'] == 'Edit form view'  || $_SESSION['page'] == 'Add form view' || $_SESSION['page'] == 'Edit table') ? 'active' : '' ?>" href="list_table.php">
                            <i class="ni ni-align-left-2 text-default"></i>
                            <span class="nav-link-text">Tables by Admins</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($_SESSION['page'] == 'users') ? 'active' : '' ?>" href="users.php">
                     ...
                     <li class="nav-item">
                        <a class="nav-link <?= ($_SESSION['page'] == 'truckowner') ? 'active' : '' ?>" href="trucks.php">
                            <i class="fa fa-truck text-blue"></i>
                            <span class="nav-link-text">Trucks Owner</span>
                        </a>
                    </li>

                     <li class="nav-item">
                        <a class="nav-link <?= ($_SESSION['page'] == 'completedorder') ? 'active' : '' ?>" href="completed_orders.php">
                            <i class="fas fa-trophy text-green"></i>
                            <span class="nav-link-text">Oders Completed</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?= ($_SESSION['page'] == 'orderincoming') ? 'active' : '' ?>" href="order_incoming.php">
                            <i class="fas fa-shopping-bag text-yellow"></i>
                            <span class="nav-link-text">Incoming Orders</span>
                        </a>

                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?= ($_SESSION['page'] == 'truck_sell_table') ? 'active' : '' ?>" href="truck_sell_table.php">
                            <i class="fas fa-truck-pickup text-purple"></i>
                            <span class="nav-link-text">Trucks On Sell </span>
                        </a>

                    </li>

                     <li class="nav-item">
                        <a class="nav-link <?= ($_SESSION['page'] == 'settings') ? 'active' : '' ?>" href="settings.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= ($_SESSION['page'] == 'API DOC') ? 'active' : '' ?>  " href="api_doc.php">
