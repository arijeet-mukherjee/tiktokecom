            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Update Record</h6>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">Update User Detail</h3>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <div class="form-horizontal" >
                            ...
                            <form action="code.php" method="POST">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" name="uid" value="<?php echo $getdata['truck_uid'] ?>" class="form-control" placeholder="Enter UID">

                                    
                                </div>
                                 <div class="form-group">
                                    
                                        <input type="text" name="name" value="<?php echo $getdata['name'] ?>" class="form-control" placeholder="Enter UID">

                                    
                                </div>
                                <div class="form-group">                                
                                        <input type="email" name="mail" value="<?php echo $getdata['mail'] ?>" class="form-control" placeholder="Enter Mail">                           
                                </div>
                                <div class="form-group">                                
                                        <input type="number" name="phone" value="<?php echo $getdata['phone'] ?>" class="form-control" placeholder="Enter Phone Number">                           
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" id="get-table-data" class="btn btn-success" name="update_truck_data">Update</button>
