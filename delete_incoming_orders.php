                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-horizontal" >
                            ...
                            <form action="code.php" method="POST">
                                ...
                                <div class="form-group">                                
                                        <input disabled type="number" name="price" value="<?php echo $getdata['paid'] ?>" class="form-control" placeholder="Enter Mail">                           
                                </div>
                                <div class="form-group">                                
                    ...
                    <div class="card-footer">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" id="get-table-data" class="btn btn-danger" name="delete_incoming_order_data">Delete</button>
