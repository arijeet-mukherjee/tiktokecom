                ...
                <div class="card">
                        ...
                        <div class="form-horizontal" >
                            <form action="code.php" method="POST">
                                <div class="form-group">
                                        ...
                                        <input type="text" name="uid" class="form-control" placeholder="Enter UID">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" id="get-table-data" class="btn btn-success" name="save_push_data">Save</button>
