            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Update Your API'S</h6>
                ...
                <div class="card">
                        ...
                        <div class="form-horizontal" >
                            ...
                            <form action="code.php" method="POST">
                                ...
                                <div class="form-group">
                                        <label for="google_api">Google Map and Place API</label>
                                    
                                        <input type="text" name="google_api" value="<?php echo $getdata['google_api'] ?>" class="form-control" placeholder="Enter Google Map Api Key">

                                    
                                </div>
                                <div class="form-group">   
                                        <label for="firebase_msg_key">Firebase Server Key</label>                             
                                        <input type="text" name="firebase_msg_api" value="<?php echo $getdata['firebase_msg_api'] ?>" class="form-control" placeholder="Enter Firebase Messaging Key">                           
                                </div>
                                <div class="form-group">
                                        <label for="razorpay_api">Razorpay API</label>                                
                                        <input type="text" name="razorpay_api" value="<?php echo $getdata['razorpay_api'] ?>" class="form-control" placeholder="Enter Razorpay APi">                           
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" id="get-table-data" class="btn btn-success" name="update_settings_data">Update</button>
