            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">Delete Oder Details</h3>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <div class="form-horizontal" >
                            ...
                            <form action="code.php" method="POST">
                                ...
                                <div class="form-group">
                                        ...
                                        <input disabled type="text" name="uid" value="<?php echo $getdata['uid'] ?>" class="form-control" placeholder="Enter UID">

                                    
                                </div>
                                <div class="form-group">                                
                                        <input disabled type="number" name="price" value="<?php echo $getdata['price'] ?>" class="form-control" placeholder="Enter Mail">                           
                                </div>
                                <div class="form-group">                                
                                        <input disabled type="text" name="time" value="<?php echo $getdata['time'] ?>" class="form-control" placeholder="Enter Phone Number">                           
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" id="get-table-data" class="btn btn-danger" name="delete_order_data">Delete</button>
                            <a href="completed_orders.php" class="btn btn-info">Cancel</a>
                        </div>
                    </div>
                    </form>
                </div>
