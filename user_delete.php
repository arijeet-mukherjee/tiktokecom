            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">Delete User Detail</h3>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <div class="form-horizontal" >
                            ...
                            <form action="code.php" method="POST">
                                ...
                                <div class="form-group">                                
                                        <input disabled type="email" name="mail" value="<?php echo $getdata['mail'] ?>" class="form-control" placeholder="Enter Mail">                           
                                </div>
                                <div class="form-group">                                
                                        <input disabled type="number" name="phone" value="<?php echo $getdata['phone'] ?>" class="form-control" placeholder="Enter Phone Number">                           
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" id="get-table-data" class="btn btn-danger" name="delete_data">Delete</button>
