                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a  href="delete_incoming_orders.php?token=<?php echo $key?>"  class="btn btn-sm btn-danger btn-icon-only rounded-circle mt-1 text-white remove" data-toggle="tooltip"  title="Remove">
             ...
             <div class="row">
                <div class="col">
                    ...
                    <!-- Card header -->
                        ...
                        <div class="card-header">
                        <h3 class=" text-uppercase text-muted  font-weight-bold mt-3 text-blue">Status Meaning</h3>
                        <h4 class="mt-2 ">Edit the <b>STATUS ID</b> for respective order under <b>EDIT STATUS</b> coloumn wrt code below</h4>
                        </div>
                        <div class="table-responsive py-3">
                            <table class="table table-flush py-5" id="custom-datatable" >
                                <thead class="thead-dark ">
                                      <tr>
                                
                                        <th class="w-25 text-green">STATUS ID</th>
                                        <th class="w-50 text-green">STATUS MEANING</th>
                                        <th class="w-50 text-green">COLOR CODE</th>
                                    </tr>
                                </thead>
                                <tbody class="thead-light">
                                    <tr>
                                        <td><?php echo 0; ?></td>
                                        <td><?php echo "CANCEL THE ORDER"; ?></td>
                                        <td class="text-red"><?php echo "RED"; ?></td>
                                    </tr>  
                                     <tr>
                                        <td><?php echo 1; ?></td>
                                        <td><?php echo "COMPLETED THE ORDER"; ?></td>
                                        <td class="text-green"><?php echo "GREEN"; ?></td>
                                    </tr> 
                                     <tr>
                                        <td><?php echo 2; ?></td>
                                        <td><?php echo "PENDING & PROCESSING"; ?></td>
                                        <td class="text-yellow"><?php echo "YELLOW"; ?></td>
                                    </tr>   
                                </tbody>
                            </table>
                        </div>
