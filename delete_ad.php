            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Delete Ad</h6>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-horizontal" >
                            ...
                            <img class="card-img-top" src="<?php echo $getdata['image_url']; ?>" alt="Image Unavailable">
                            <div class="card-body left">
                                <p class="card-text"><?php echo $getdata['description']; ?></p>
                            </div>
                            </div>
                            <form action="code.php" method="POST">
                                ...
                                <div class="form-group">
                                        ...
                                        <input disabled type="text" name="ad_id" value="<?php echo $getdata['id'] ?>" class="form-control" placeholder="Enter UID">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" id="get-table-data" class="btn btn-danger" name="delete_ad">Delete</button>
                            <a href="truck_sell_table.php" class="btn btn-info">Cancel</a>
                        </div>
                    </div>
                    </form>
                </div>
